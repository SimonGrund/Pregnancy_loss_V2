...
ggsave("Results/Figures/SECONDARY_RPL_Losses_before_reference.pdf", device = "pdf", height = 4, width = 6)
openxlsx::write.xlsx(out_tab, "Results/Tables/Biomarkers_function_of_loss_SECONDARY_RPL_COHORT.xlsx")
